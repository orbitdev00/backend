  ...
  return (
    <div className="auth-page orbit-page-fadein">
      <div className="auth-card">
        ...
        {onTrial && (
          <button className="btn-trial" onClick={onTrial}>
            Try one free analysis — no account needed
          </button>
        )}

        <div className="auth-footer">
          <span>Don't have an account? <button className="link-btn" onClick={() => onSwitch('signup')}>Sign up</button></span>
